 ...
 *          </table>
 */
public class BuildGenerator extends AbstractGenerator {

	/* (non-Javadoc)
	 * @see com.ymatesoft.scaffold.IGenerator#getTemplateFilePath()
	 */
	public String getTemplateFilePath() {
		return TemplateFactory.TEMPLATE_ROOT_PATH +"/pluginprj/build.ftl";
	}
	...
	public Map<String, Object> getTemplatePropMap() {
		...
		_propMap.put("jar_name", Config.getValue("plugin_jar_name"));
