/**
 * <p>文件名:	StartupCmdGenerator.java</p>
 * <p>版权:		详见产品版权说明书</p>
 ...
 *          </table>
 */
public class StartupCmdGenerator extends AbstractGenerator {

	/* (non-Javadoc)
	 * @see com.ymatesoft.scaffold.IGenerator#getTemplateFilePath()
	 */
	public String getTemplateFilePath() {
		return TemplateFactory.TEMPLATE_ROOT_PATH +"/tomcatserv/startup-cmd.ftl";
	}
