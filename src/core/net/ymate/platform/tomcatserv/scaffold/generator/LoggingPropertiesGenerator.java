/**
 * <p>文件名:	LoggingPropertiesGenerator.java</p>
 * <p>版权:		详见产品版权说明书</p>
...
/**
 * <p>
 * LoggingPropertiesGenerator
 * </p>
 * <p>
 * logging.properties配置文件生成器；
 * </p>
 * 
 ...
 *          </table>
 */
public class LoggingPropertiesGenerator extends AbstractGenerator {

	/* (non-Javadoc)
	 * @see com.ymatesoft.scaffold.IGenerator#getTemplateFilePath()
	 */
	public String getTemplateFilePath() {
		return TemplateFactory.TEMPLATE_ROOT_PATH +"/tomcatserv/logging-properties.ftl";
	}
	...
	public String getTargetFileName() {
		return "conf/logging.properties";
	}
