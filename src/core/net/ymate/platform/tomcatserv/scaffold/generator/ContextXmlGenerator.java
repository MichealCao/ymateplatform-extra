/**
 * <p>文件名:	ContextXmlGenerator.java</p>
 * <p>版权:		详见产品版权说明书</p>
 ...
 *          </table>
 */
public class ContextXmlGenerator extends AbstractGenerator {

	/* (non-Javadoc)
	 * @see com.ymatesoft.scaffold.IGenerator#getTemplateFilePath()
	 */
	public String getTemplateFilePath() {
		return TemplateFactory.TEMPLATE_ROOT_PATH +"/tomcatserv/context-xml.ftl";
	}
