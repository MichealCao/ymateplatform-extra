/**
 * <p>文件名:	BaseEntityGenerator.java</p>
 * <p>版权:		详见产品版权说明书</p>
...
public class BaseEntityGenerator extends AbstractGenerator {
	...
	public String getTargetFileName() {
		return ((String) this.getParamItem("packageName")).replace('.', '/') + "/model/BaseEntity.java";
	}
	...
	public String getTemplateFilePath() {
		return TemplateFactory.TEMPLATE_ROOT_PATH +"/jdbc/base-entity.ftl";
	}
