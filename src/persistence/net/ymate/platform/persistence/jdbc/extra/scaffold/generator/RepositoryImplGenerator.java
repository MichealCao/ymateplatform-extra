/**
 * <p>文件名:	RepositoryImplGenerator.java</p>
 * <p>版权:		详见产品版权说明书</p>
...
public class RepositoryImplGenerator extends AbstractGenerator {
	 ...
	 */
	public RepositoryImplGenerator(String repositoryName) {
	...
	public String getTemplateFilePath() {
		return TemplateFactory.TEMPLATE_ROOT_PATH +"/jdbc/repository-impl.ftl";
	}
